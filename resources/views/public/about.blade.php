...
@section('title', 'About Us | DevineSky CRM')
@section('content')
...
<section class="section-padding" style="background:var(--surface);">
    <div style="max-width:800px; margin:0 auto; text-align:center;">
        <h2 style="font-family:'Plus Jakarta Sans', sans-serif; font-size:32px; color:var(--dark); margin-bottom:24px;" data-aos="fade-up">Why We Built DevineSky</h2>
        ...
        <p style="font-size:18px; color:var(--text); line-height:1.8; margin-bottom:40px;" data-aos="fade-up" data-aos-delay="200">DevineSky was founded in 2026 to flip this dynamic. We combined state-of-the-art Large Language Models with deep CRM architecture to create a system that works for you, not the other way around. DevineSky thinks, writes, and organizes so your team can focus on closing deals.</p>
