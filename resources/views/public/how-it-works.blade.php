...
@section('title', 'How it Works | DevineSky CRM')
@section('content')
<div class="page-header">
    <h1 data-aos="fade-up">How DevineSky Automates Your Sales</h1>
    <p data-aos="fade-up" data-aos-delay="100">DevineSky AI operates as a seamless pipeline, from lead capture to deal closure.</p>
</div>
    ...
    <div style="max-width:800px; margin:0 auto;">
        ...
        <div style="display:flex; gap:30px; margin-bottom:60px;" data-aos="fade-up">
            ...
            <div>
                ...
                <p style="color:var(--text); font-size:16px; line-height:1.7;">DevineSky ingests leads from everywhere: your website forms, direct emails, and incoming WhatsApp messages. Everything lands in a unified, organized dashboard instantly.</p>
            </div>
        </div>
        ...
        <div style="display:flex; gap:30px;" data-aos="fade-up">
            ...
            <div>
                ...
                <p style="color:var(--text); font-size:16px; line-height:1.7;">DevineSky drafts highly personalized email and WhatsApp responses that address the exact pain points the lead mentioned. You just click "Approve and Send".</p>
            </div>
        </div>
